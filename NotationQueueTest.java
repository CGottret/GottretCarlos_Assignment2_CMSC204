...
public class NotationQueueTest {
    ...
    public void testDequeueStudent() {
        ...
        try {
            assertEquals(4.2, doubleQ.dequeue());
            assertEquals(6.9, doubleQ.dequeue());
            assertEquals(5.5, doubleQ.dequeue());
            doubleQ.dequeue();
            assertTrue("This should have caused an QueueUnderflowException", false);
        }
        catch (QueueUnderflowException e){
    ...
    public void testEnqueueStudent() {
        ...
        try{
            ...
            assertEquals(true, doubleQ.enqueue(1.1));
            assertEquals(4, doubleQ.size());
            assertEquals(true, doubleQ.enqueue(2.2));
    ...
    public void testToStringStudent() throws QueueOverflowException{
        //Use the doubleQ for student tests
        assertEquals("4.26.95.5", doubleQ.toString());
        doubleQ.enqueue(1.1);
        assertEquals("4.26.95.51.1", doubleQ.toString());
        doubleQ.enqueue(2.2);
        assertEquals("4.26.95.51.12.2", doubleQ.toString());
    }
